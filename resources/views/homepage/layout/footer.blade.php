        ...
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                ...
                <div class="d-flex hightech-link">
                    <a href="https://id-id.facebook.com/" class="btn-light nav-fill btn btn-square rounded-circle me-2"><i
                            class="fab fa-facebook-f text-primary"></i></a>
                    <a href="https://x.com/?lang=en-id" class="btn-light nav-fill btn btn-square rounded-circle me-2"><i
                            class="fab fa-twitter text-primary"></i></a>
                    <a href="https://www.instagram.com/" class="btn-light nav-fill btn btn-square rounded-circle me-2"><i
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="mt-4 d-flex flex-column short-link">
                    <a href="#about" class="mb-2 text-white"><i
                            class="fas fa-angle-right text-secondary me-2"></i>About</a>
                    <a href="#gallery" class="mb-2 text-white"><i
                            class="fas fa-angle-right text-secondary me-2"></i>Gallery</a>
                    <a href="#berita" class="mb-2 text-white"><i class="fas fa-angle-right text-secondary me-2"></i>Berita desa</a>
                    <a href="#struktur" class="mb-2 text-white"><i class="fas fa-angle-right text-secondary me-2"></i>Struktur desa</a>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                ...
                <div class="text-white mt-4 d-flex flex-column contact-link">
                    <a href="#" class="pb-3 text-light border-bottom border-primary"><i
                            class="fas fa-map-marker-alt text-secondary me-2"></i> London kidul</a>
